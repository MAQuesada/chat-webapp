...
<td>
<h1>Sample Chat WebApp (Database JSP)</h1>
This is the output of a JSP page to show <b>SQL database interactivity</b>.
</td>
</tr>
</table>
...
%>
<p>InetAddress: <%=serverAddress %></p>
<p>InetAddress.hostname: <%=hostname %></p>
<%
if (url==null) {
%>
